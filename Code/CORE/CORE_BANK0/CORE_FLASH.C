...
//-----------------------------------------------------------------------------
// Bios get the EC low Version
//-----------------------------------------------------------------------------
#pragma ot(7, SIZE)
void BIOS_Get_EC_LowVersion(void)
{
     PM2DO = OEM_Version_LSB;
}



//-----------------------------------------------------------------------------
// Bios get the EC high Version
//-----------------------------------------------------------------------------
#pragma ot(7, SIZE)
void BIOS_Get_EC_HighVersion(void)
{
     PM2DO = OEM_Version_MSB;		
}
