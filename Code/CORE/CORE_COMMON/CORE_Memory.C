...
IBYTE   	PM34Cmd							_at_ 0x59;
IBYTE 		PM34DataCount					_at_ 0x5A;
IBYTE		PM34Data							_at_ 0x5B;
IBYTE 		PM34Data1						_at_ 0x5C;
IBYTE 		PM34Data2						_at_ 0x5D;
IBYTE 		MainFucnLow						_at_ 0x5E;
IBYTE 		MainFucnHigh					_at_ 0x5F;
									    //Reserved 0x60 ~ 0x64
IWORD		ITempW02						_at_ 0x60;									    
