...
KeilMisc\Obj\OEM_HEAT.OBJ:Code\Oem\OEM_HEAT.C $(COREInclude) $(OEMInclude) $(CHIPInclude)
	$(CC) Code\Oem\OEM_HEAT.C $(CDirectives)
	move Code\Oem\OEM_HEAT.OBJ KeilMisc\Obj
	move Code\Oem\OEM_HEAT.LST KeilMisc\Lst
